...
from core.gaussianunet import GaussianUnet
...
class LGM_gaussian(nn.Module):
    def __init__(
        ...
        self.gaussian_unet=GaussianUnet()
    ...
    def get_optimizer(self):
        return torch.optim.Adamw(self.gaussian_unet.parameters(), lr=self.opt.lr, weight_decay=0.05, betas=(0.9, 0.95))